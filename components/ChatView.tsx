                            ...
                            <form onSubmit={handleChatSubmit} className="relative group">
                                ...
                                <div className="relative flex flex-col bg-[#27272a] border border-zinc-700/50 rounded-3xl shadow-2xl overflow-hidden transition-colors focus-within:border-zinc-600">
                                    ...
                                    <div className="absolute bottom-2 right-2 flex items-center gap-1">
                                        ...
                                        <button type="button" onClick={triggerFileSelect} className="p-2 rounded-full text-white hover:bg-zinc-700/50 transition-colors" title="Attach File"><svg className="w-5 h-5" viewBox="0 0 24 24"><path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg></button>
                                        <div className={`p-2 rounded-full transition-colors cursor-default ${isReasoningEnabled ? 'text-white' : 'text-zinc-600'}`} title="Reasoning Active"><svg className="w-5 h-5" viewBox="0 0 24 24"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z"/></svg></div>
                                        <button type="button" onClick={startListening} className={`p-2 rounded-full transition-all duration-200 text-white hover:bg-zinc-700/50`}><svg className="w-5 h-5" viewBox="0 0 24 24"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/></svg></button>
