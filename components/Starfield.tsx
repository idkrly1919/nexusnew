...
const Starfield = () => {
    ...
    return (
        <div className="fixed inset-0 z-0 overflow-hidden bg-black">
            ...
            <div className="shooting-star" style={{ top: '10vh', animationDuration: '8s', animationDelay: '1s' }}></div>
            <div className="shooting-star" style={{ top: '50vh', animationDuration: '12s', animationDelay: '5s' }}></div>
            <div className="shooting-star" style={{ top: '80vh', animationDuration: '10s', animationDelay: '9s' }}></div>
        </div>
    );
};
