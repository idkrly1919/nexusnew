        ...
        <>
            ...
            <div id="landing-view" className="relative z-10">
                ...
                <main className="pt-32 pb-20">
                    ...
                    {/* New Section for the embed button */}
                    <div className="max-w-5xl mx-auto px-6 mt-32 text-center">
                        ...
                        <div className="mt-8">
                            <button 
                                ...
                                className="bg-indigo-600 hover:bg-indigo-500 text-white px-8 py-4 rounded-lg font-medium transition-all shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_30px_rgba(79,70,229,0.5)] whitespace-nowrap flex items-center gap-2 mx-auto"
                            >
