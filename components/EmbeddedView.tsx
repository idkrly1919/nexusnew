...
const EmbeddedView: React.FC<EmbeddedViewProps> = ({ url, onClose }) => {
    return (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-lg z-[100] flex flex-col items-center justify-center p-4 animate-in fade-in duration-300">
            ...
            <div className="w-full h-full max-w-6xl max-h-[90vh] flex flex-col glass-panel rounded-2xl overflow-hidden">
                <div className="flex-shrink-0 p-4 bg-zinc-900/50 border-b border-zinc-800 flex items-center justify-between">
