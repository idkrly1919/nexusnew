                ...
                return (
                    <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <LiquidGlass
                                        ...
                                        elasticity={0.2}
                                    >
                                        <input id="email" name="email" type="email" value={email} onChange={e => setEmail(e.target.value)} required className="w-full bg-transparent border-none text-white placeholder-zinc-500 focus:outline-none" placeholder="you@example.com" />
                                    </LiquidGlass>
                                </div>
                            </div>
                            <LiquidGlass
                                ...
                                className="w-full"
                            >
                                <button type="submit" disabled={isLoading} className="w-full flex justify-center text-sm font-medium text-white bg-transparent border-none">
                        ...
                        <LiquidGlass
                            ...
                            elasticity={0.3}
                            overLight={true}
                            className="w-full no-invert"
                        >
                            <button disabled={isLoading} className="w-full flex items-center justify-center gap-3 text-sm font-medium text-black bg-transparent border-none disabled:opacity-50">
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <LiquidGlass
                                    ...
                                    elasticity={0.2}
                                >
                                    <input id="password" name="password" type="password" value={password} onChange={e => setPassword(e.target.value)} required className="w-full bg-transparent border-none text-white placeholder-zinc-500 focus:outline-none" placeholder="Enter password" />
                                </LiquidGlass>
                            </div>
                ...
                return (
                    <form onSubmit={handleForgotPassword} className="space-y-6 animate-pop-in">
                        ...
                        <LiquidGlass
                            ...
                            elasticity={0.2}
                        >
                            <input type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="Enter your email" className="w-full bg-transparent border-none text-white placeholder-zinc-500 focus:outline-none" />
                        </LiquidGlass>
                ...
                return (
                    <form onSubmit={handleSignup} className="space-y-4 animate-pop-in">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <LiquidGlass padding="12px 16px" cornerRadius={999} elasticity={0.2}>
                                <input type="text" placeholder="First Name" value={firstName} onChange={e => setFirstName(e.target.value)} required className="w-full bg-transparent border-none text-white placeholder-zinc-500 focus:outline-none" />
                            </LiquidGlass>
                            <LiquidGlass padding="12px 16px" cornerRadius={999} elasticity={0.2}>
                                <input type="text" placeholder="Last Name" value={lastName} onChange={e => setLastName(e.target.value)} required className="w-full bg-transparent border-none text-white placeholder-zinc-500 focus:outline-none" />
                            </LiquidGlass>
                        </div>
                        <LiquidGlass padding="12px 16px" cornerRadius={999} elasticity={0.2}>
                            <input type="password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} required className="w-full bg-transparent border-none text-white placeholder-zinc-500 focus:outline-none" />
                        </LiquidGlass>
                        <LiquidGlass padding="12px 16px" cornerRadius={999} elasticity={0.2}>
                            <input type="password" placeholder="Confirm Password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} required className="w-full bg-transparent border-none text-white placeholder-zinc-500 focus:outline-none" />
                        </LiquidGlass>
