...
// Explicitly configure the client to use our localStorage adapter for session persistence.
// This ensures the user remains logged in across browser sessions, especially on desktop browsers
// that might have stricter storage policies.
