                            ...
                            <form onSubmit={handleChatSubmit} className="relative">
                                <div data-liquid-glass className="liquid-glass rounded-full flex items-center p-2 transition-all duration-300 focus-within:shadow-2xl focus-within:shadow-indigo-500/20">
                                    ...
                                    <div className="flex items-center gap-1">
                                        <button type="button" onClick={() => setIsGeminiLiveMode(true)} className="p-2 rounded-full text-indigo-400 hover:text-indigo-300 hover:bg-indigo-500/20 transition-colors" title="Gemini Live"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/><path d="M8 2h8"/></svg></button>
