                                        ...
                                        <div key={groupName} className="mb-3">
                                            ...
                                            {groupConversations.map(chat => (
                                                <div key={chat.id} className="relative group">
                                                    <button onClick={() => navigate(chat.type === 'dev' ? `/dev/${chat.id}` : `/chat/${chat.id}`)} className={`w-full text-left pl-3 pr-8 py-2 text-sm rounded-lg transition-colors duration-200 truncate ${currentConversationId === chat.id ? 'bg-white/10 text-white' : 'text-zinc-400 hover:bg-white/5 hover:text-white'}`}>
